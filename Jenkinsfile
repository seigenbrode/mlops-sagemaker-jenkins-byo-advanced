            ...
            steps { 
              sh """
               if ! aws cloudformation describe-stacks --region us-east-1 --stack-name '${params.SAGEMAKER_TRAINING_JOB}'-prod ; then
                  ...
                  ParameterKey=DataCaptureS3Bucket,ParameterValue="${params.SAGEMAKER_MM_BUCKET}/data-capture-prod" ParameterKey=TrainingJobName, ParameterValue="${params.SAGEMAKER_TRAINING_JOB}-${env.BUILD_ID}"
                  echo "Waiting for stack to be created ..."
